...
extern "C" {
    ...
    typedef struct llama_paged_batch_info {
        ...
        int32_t * write_slots    = nullptr;  // [n_tokens]
        int32_t * block_table    = nullptr;  // [n_seq * n_blocks_per_seq]
        int32_t * context_lens   = nullptr;  // [n_seq]
        int32_t * batch_offsets  = nullptr;  // [n_seq]
        int32_t * batch_lens     = nullptr;  // [n_seq]
    ...
    struct llama_context_params {
        ...
        uint32_t n_cpu_blocks;       // CPU block pool size for swap-ou
